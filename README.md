...
|---|---------------|----:|
| `y` |  The noisy time-series to be differentitated to the order `d`. This should be a `numpy` array. Notice that this time series should be normalized so that the maximum absolute values is lower than 1 (approximately, outliers excluded)| --|
